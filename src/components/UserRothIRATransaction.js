...
export function UserRothIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_ROTH_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rothira/deposittransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_ROTH_IRA_DEPOSIT_URL, {
        ...
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Roth IRA Deposit</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRothIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_ROTH_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rothira/withdrawtransaction";
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(USER_ROTH_IRA_WITHDRAW_URL, {
    ...
    return (
        <div className="container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Roth IRA Withdraw</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRothIRATransferTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    ...
    const ROTH_IRA_TRANSFER_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rothira/transfer";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROTH_IRA_TRANSFER_URL, {
    ...
    return (
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Roth IRA Transfer</BreadcrumbItem>
                </Breadcrumb>
 ...
 export function UserRothIRAGetTransaction() {

    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const USER_ROTH_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rothira/transactions";
    ...
    const handleSubmit = async () => {
        ...
        await fetch(USER_ROTH_IRA_TRANSACTION_URL, {
    ...
    return (
        <div className=" container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Roth IRA Transactions</BreadcrumbItem>
                </Breadcrumb>
