...
export function UserCDDepositTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_CD_DEPOSIT_URL =process.env.REACT_APP_API_ENDPOINT+"Me/cdaccount/{accountNum}/deposittransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_CD_DEPOSIT_URL.replace('{accountNum}', `${accNum}`), {
        ...
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active> CD Checking Deposit</BreadcrumbItem>
                </Breadcrumb>
...
export function UserCDWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");

    const USER_CD_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"Me/cdaccount/{accountNum}/withdrawtransaction";
    const bearer = 'Bearer ' + localStorage.getItem('token');
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_CD_WITHDRAW_URL.replace('{accountNum}', `${accNum}`), {
    ...
    return (
        <div className="container ">
            <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> CD Withdraw</BreadcrumbItem>
                </Breadcrumb>
...
export function UserCDTransferTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
   ...
   // const [type, setType] = useState("");
    ...
    const CD_TRANSFER_URL = process.env.REACT_APP_API_ENDPOINT+"Me/cdaccount/{accountNum}/transfer";
    const bearer = 'Bearer ' + localStorage.getItem('token');
const transfertype="Transfer"
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(CD_TRANSFER_URL.replace('{accountNum}', sourceAccNum), {
    ...
    return (
        <div className="container ">
            <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> CD Transfer</BreadcrumbItem>
                </Breadcrumb>
...
export function UserCDGetTransaction() {

    //const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const USER_CD_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"Me/cdaccount/{accountNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(USER_CD_TRANSACTION_URL.replace('{accountNum}', accNum), {
    ...
    return (
        <div className=" container">
            <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> CD Checking Transactions</BreadcrumbItem>
                </Breadcrumb>
