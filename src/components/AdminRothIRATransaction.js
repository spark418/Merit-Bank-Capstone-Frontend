...
export function RothIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const ROTH_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rothIRA/{accNum}/deposittransaction";
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(ROTH_IRA_DEPOSIT_URL.replace('{id}/rothIRA/{accNum}', `${accHolderId}/rothIRA/${accNum}`), {
...
export function RothIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const ROTH_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rothIRA/{accNum}/withdrawtransaction";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROTH_IRA_WITHDRAW_URL.replace('{id}/rothIRA/{accNum}', `${accHolderId}/rothIRA/${accNum}`), {
...
export function RothIRAGetTransaction() {

    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const ROTH_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rothIRA/{accNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROTH_IRA_TRANSACTION_URL.replace('{id}/rothIRA/{accNum}', `${accHolderId}/rothIRA/${accNum}`), {
