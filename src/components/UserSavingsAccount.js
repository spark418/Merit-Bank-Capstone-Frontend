...
export function UserAddSavingsAccount() {
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(USER_SAVINGSACCOUNT_URL, {
        ...
        .then(res=> {
            if(res.ok){
                ...
                alert(`Successfully opened a new Savings Account for you!`);
                return res;
            } else {
...
export function UserGetSavingsAccount() {
        ...
        <div className="container ">
            ...
            <div className="row">
                <div className="col-md-7">
                    ...
                    <h2 className="text-align-center">Savings Account List</h2>
