...
export function SavingsDepositTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const SAVINGS_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/savingsaccounts/{accNum}/deposittransaction";
    ...
    const handleSubmit = async (event) => {
       ...
       await fetch(SAVINGS_DEPOSIT_URL.replace('{id}/savingsaccounts/{accNum}', `${accHolderId}/savingsaccounts/${accNum}`), {
...
export function SavingsWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const SAVINGS_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/savingsaccounts/{accNum}/withdrawtransaction";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(SAVINGS_WITHDRAW_URL.replace('{id}/savingsaccounts/{accNum}', `${accHolderId}/savingsaccounts/${accNum}`), {
...
export function SavingsGetTransaction() {

    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const SAVINGS_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/savingsaccounts/{accNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(SAVINGS_TRANSACTION_URL.replace('{id}/savingsaccounts/{accNum}', `${accHolderId}/savingsaccounts/${accNum}`), {
