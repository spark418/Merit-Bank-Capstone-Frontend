...
export function RegularIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const REGULAR_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/regularIRA/{accNum}/deposittransaction";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(REGULAR_IRA_DEPOSIT_URL.replace('{id}/regularIRA/{accNum}', `${accHolderId}/regularIRA/${accNum}`), {
...
export function RegularIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const REGULAR_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/regularIRA/{accNum}/withdrawtransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(REGULAR_IRA_WITHDRAW_URL.replace('{id}/regularIRA/{accNum}', `${accHolderId}/regularIRA/${accNum}`), {
...
export function RegularIRAGetTransaction() {

    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const REGULAR_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/regularIRA/{accNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(REGULAR_IRA_TRANSACTION_URL.replace('{id}/regularIRA/{accNum}', `${accHolderId}/regularIRA/${accNum}`), {
