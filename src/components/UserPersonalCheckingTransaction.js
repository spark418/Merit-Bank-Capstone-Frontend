...
export function UserPersonalCheckingDepositTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_PERSONAL_CHECKING_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"Me/checkingaccount/deposittransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_PERSONAL_CHECKING_DEPOSIT_URL, {
...
export function UserPersonalCheckingWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_PERSONAL_CHECKING_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"Me/checkingaccount/withdrawtransaction";
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(USER_PERSONAL_CHECKING_WITHDRAW_URL, {
...
export function UserPersonalCheckingTransferTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [sourceAccNum, setSourceAccNum] = useState("");
    const [targetAccNum, setTargetAccNum] = useState("");
    const [type, setType] = useState("");
    const PERSONAL_CHECKING_TRANSFER_URL = process.env.REACT_APP_API_ENDPOINT+"Me/checkingaccount/transfer";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(PERSONAL_CHECKING_TRANSFER_URL, {
    ...
    return (
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Personal Checking Transfer</BreadcrumbItem>
                </Breadcrumb>
 ...
 export function UserPersonalCheckingGetTransaction() {

    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const USER_PERSONAL_CHECKING_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"Me/checkingaccount/transactions";
    ...
    const handleSubmit = async () => {
        ...
        await fetch(USER_PERSONAL_CHECKING_TRANSACTION_URL, {
    ...
    return (
        <div className=" container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Personal Checking Transactions</BreadcrumbItem>
                </Breadcrumb>
