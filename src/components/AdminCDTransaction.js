...
export function CDDepositTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const CD_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/cdaccounts/{accNum}/deposittransaction";
    ...
    const handleSubmit = async (event) => {
       ...
       await fetch(CD_DEPOSIT_URL.replace('{id}/cdaccounts/{accNum}', `${accHolderId}/cdaccounts/${accNum}`), {
        ...
        <div className="container">
             <div className="row">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>CD Deposit</BreadcrumbItem>
                </Breadcrumb>
...
export function CDWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const CD_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/cdaccounts/{accNum}/withdrawtransaction";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(CD_WITHDRAW_URL.replace('{id}/cdaccounts/{accNum}', `${accHolderId}/cdaccounts/${accNum}`), {
...
export function CDGetTransaction() {

    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const CD_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/cdaccounts/{accNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(CD_TRANSACTION_URL.replace('{id}/cdaccounts/{accNum}', `${accHolderId}/cdaccounts/${accNum}`), {
    ...
    return (
        <div className=" container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/admin">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active>CD Transaction</BreadcrumbItem>
                </Breadcrumb>
