...
export function UserRegularIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_REGULAR_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"Me/regularira/deposittransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_REGULAR_IRA_DEPOSIT_URL, {
        ...
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Regular IRA Deposit</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRegularIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_REGULAR_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"Me/regularira/withdrawtransaction";
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(USER_REGULAR_IRA_WITHDRAW_URL, {
    ...
    return (
        <div className="container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Regular IRA Withdraw</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRegularIRATransferTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    ...
    const REGULAR_IRA_TRANSFER_URL = process.env.REACT_APP_API_ENDPOINT+"Me/regularira/transfer";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(REGULAR_IRA_TRANSFER_URL, {
    ...
    return (
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Regular IRA Transfer</BreadcrumbItem>
                </Breadcrumb>
 ...
 export function UserRegularIRAGetTransaction() {

    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const USER_REGULAR_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"Me/regularira/transactions";
    ...
    const handleSubmit = async () => {
        ...
        await fetch(USER_REGULAR_IRA_TRANSACTION_URL, {
    ...
    return (
        <div className=" container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Regular IRA Transactions</BreadcrumbItem>
                </Breadcrumb>
