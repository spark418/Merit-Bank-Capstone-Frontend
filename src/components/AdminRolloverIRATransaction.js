...
export function RolloverIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const ROLLOVER_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rolloverIRA/{accNum}/deposittransaction";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROLLOVER_IRA_DEPOSIT_URL.replace('{id}/rolloverIRA/{accNum}', `${accHolderId}/rolloverIRA/${accNum}`), {
...
export function RolloverIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const ROLLOVER_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rolloverIRA/{accNum}/withdrawtransaction";
    ...
    const handleSubmit = async (event) => {
       ...
       await fetch(ROLLOVER_IRA_WITHDRAW_URL.replace('{id}/rolloverIRA/{accNum}', `${accHolderId}/rolloverIRA/${accNum}`), {
...
export function RolloverIRAGetTransaction() {

    const [accHolderId, setAccHolderId] = useState("");
    const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const ROLLOVER_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"accountholder/{id}/rolloverIRA/{accNum}/transactions";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROLLOVER_IRA_TRANSACTION_URL.replace('{id}/rolloverIRA/{accNum}', `${accHolderId}/rolloverIRA/${accNum}`), {
