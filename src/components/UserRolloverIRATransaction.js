...
export function UserRolloverIRADepositTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_ROLLOVER_IRA_DEPOSIT_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rolloverira/deposittransaction";
    ...
    const handleSubmit = async(event) => {
        ...
        await fetch(USER_ROLLOVER_IRA_DEPOSIT_URL, {
        ...
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    ...
                    <BreadcrumbItem active>Rollover IRA Deposit</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRolloverIRAWithdrawTransaction() {
    const [amount, setAmount] = useState("");
    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [type, setType] = useState("");
    const USER_ROLLOVER_IRA_WITHDRAW_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rolloverira/withdrawtransaction";
    ...
    const handleSubmit =async (event) => {
        ...
        await fetch(USER_ROLLOVER_IRA_WITHDRAW_URL, {
    ...
    return (
        <div className="container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Rollover IRA Withdraw</BreadcrumbItem>
                </Breadcrumb>
...
export function UserRolloverIRATransferTransaction() {
    const [amount, setAmount] = useState("");
    const [accHolderId, setAccHolderId] = useState("");
    ...
    const ROLLOVER_IRA_TRANSFER_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rolloverira/transfer";
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(ROLLOVER_IRA_TRANSFER_URL, {
    ...
    return (
        <div className="container ">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Rollover IRA Transfer</BreadcrumbItem>
                </Breadcrumb>
 ...
 export function UserRolloverIRAGetTransaction() {

    //const [accHolderId, setAccHolderId] = useState("");
    //const [accNum, setAccNum] = useState("");
    const [transact, setTransact] = useState([]);

    const USER_ROLLOVER_IRA_TRANSACTION_URL = process.env.REACT_APP_API_ENDPOINT+"Me/rolloverira/transactions";
    ...
    const handleSubmit = async () => {
        ...
        await fetch(USER_ROLLOVER_IRA_TRANSACTION_URL, {
    ...
    return (
        <div className=" container">
             <div className="row">
                <Breadcrumb>
                    <BreadcrumbItem><Link to="/user">Home</Link></BreadcrumbItem>
                    <BreadcrumbItem active> Rollover IRA Transactions</BreadcrumbItem>
                </Breadcrumb>
