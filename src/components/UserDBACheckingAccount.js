...
export function UserAddDBACheckingAccount() {
    ...
    const USER_DBA_CHECKINGACCOUNT_URL = process.env.REACT_APP_API_ENDPOINT+"Me/dbacheckingaccounts";
        ...
        <div className="container ">
            ...
            <div className="row">
                <div className="col-md-7">
                    ...
                    <h2 className="text-align-center">DBA Checking Account List</h2>
