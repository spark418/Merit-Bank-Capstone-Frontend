...
export function UserAddRegularIRAAccount() {
    ...
    const handleSubmit = async (event) => {
        ...
        await fetch(USER_REGULAR_IRAACCOUNT_URL, {
        ...
        .then(res=> {
            if(res.ok){
                ...
                alert(`Successfully opened a new Regular IRA Account for you!`);
                return res;
            } else {
...
export function UserGetRegularIRAAccount() {
        ...
        <div className="container mt-5">
            <div className="row">
                <div className="col-md-7">
                    ...
                    <h2 className="text-align-center">Regular IRA Account List</h2>
